...
p <- PwrCon$Global_active_power
q <- PwrCon$Voltage
r <- PwrCon$Global_reactive_power

a <- PwrCon$Sub_metering_1
b <- PwrCon$Sub_metering_2
c <- PwrCon$Sub_metering_3

## Open Graphic Device and Make Plots
png(file="plot4.png", width = 480, height = 480)
par(mar=c(5,4,4,2), mfcol = c(2,2))

###Plot 1,1
plot(x, p, type = "l", lty = 1, xlab = "", ylab = "Global Active Power")
...
###Plot 1,2
plot(x, q, type = "l", lty = 1, xlab = "datetime", ylab = "Voltage")

###Plot 2,2
plot(x, r, type = "l", lty = 1, xlab = "datetime", ylab = "Global_reactive_power")
